      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return _axios.default.post('http://localhost:2000/api/v1/users/login', {
              email: email,
              password: password
            });
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', _context.t0.response.data.err.errorMessage);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.get('http://localhost:2000/api/v1/users/logout');
          ...
          case 7:
            ...
            //const data=JOSN.parse(err)
            console.log('err is', _context2.t0.response);
            (0, _alert.showAlert)('error', _context2.t0.response.data.err.errorMessage);
...
},{}],"updateProfile.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:2000/api/v1/users/updatePassword' : 'http://localhost:2000/api/v1/users/updateMe';
            _context.next = 4;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("http://localhost:2000/api/v1/booking/checkout-session/".concat(tourId));
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](1);
            console.log("errir is", _context.t0);
...
var updateProfileButton = document.querySelector('.save-setting');
var updatePassword = document.querySelector('.btn--password-save');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return (0, _updateProfile.updateProfile)({
                password: password,
            ...
            case 6:
              ...
              (0, _alert.showAlert)('success', 'You are logout ,Please Login again'); //logout();
