      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.patch('http://localhost:2000/api/v1/users/updateMe', {
              name: name,
              email: email
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Data Changed successfully!');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1000);
            }
...
if (updateProfileButton) {
  updateProfileButton.addEventListener('click', function (e) {
    ...
    (0, _updateProfile.updateProfile)(name, email);
  });
}
